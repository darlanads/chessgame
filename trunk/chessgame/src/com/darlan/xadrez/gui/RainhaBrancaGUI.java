/*
 * @(#)RainhaBrancaGUI.java 1.0 11/10/2005
 *
 ...
 */
public class RainhaBrancaGUI extends AbstractPecaGUI{
	...
	* @param y Ordenada
	*/
	public RainhaBrancaGUI( int x, int y)
	{
		super(Global.IMG_RAINHA_BRANCA);
		super.x = x;
		super.y = y;
