/*
 * @(#)CavaloPretoGUI.java 1.0 11/10/2005
 *
 ...
 */
public class CavaloPretoGUI extends AbstractPecaGUI{
	...
	* @param y Ordenada
	*/
	public CavaloPretoGUI( int x, int y)
	{
		super(Global.IMG_CAVALO_PRETO);
		super.x = x;
		super.y = y;
